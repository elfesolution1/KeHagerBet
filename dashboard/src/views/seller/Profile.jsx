    ...
    <div className="px-2 lg:px-7 py-5">
      <div className="w-full flex flex-wrap">
        <div className="w-full md:w-6/12">
          <div className="w-full p-4  bg-white rounded-md text-[#283046]">
            ...
            <div className="px-0 md:px-5 py-2">
              {!userInfo?.shopInfo ? (
                <form onSubmit={add}>
                  <div className="flex flex-col w-full gap-1 mb-3">
                    ...
                    <input
                      ...
                      className="px-4 py-2 focus:border-indigo-500 outline-none bg-slate-200 border border-slate-700 rounded-md text-[#283046]"
                      type="text"
                  ...
                  <button
                    ...
                    className="bg-orange-500 w-[190px] hover:shadow-orange-500/20 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3"
                  >
                    {loader ? (
                      <PropagateLoader
                        color="#fff"
                ...
                <div className="flex justify-between text-sm flex-col gap-2 p-4 bg-white rounded-md relative">
                  <span className="p-[6px] bg-yellow-500 rounded hover:shadow-lg hover:shadow-yellow-500/50 absolute right-2 top-2 cursor-pointer">
                    <FaEdit />
                  </span>
                  <div className="flex gap-2">
        ...
        <div className="w-full md:w-6/12">
          <div className="w-full pl-0 md:pl-7 mt-6 md:mt-0  ">
            <div className="bg-white rounded-md text-[#283046] p-4">
              <h1 className="text-[#283046] text-lg mb-3 font-semibold">
                Change Password
              </h1>
              <form>
                <div className="flex flex-col w-full gap-1 mb-3">
                ...
                <button className="bg-orange-500 hover:shadow-orange-500/50 hover:shadow-lg text-white rounded-md px-7 py-2 mt-5 ">
                  Submit
                </button>
              </form>
            </div>
