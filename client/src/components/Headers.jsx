        ...
        <div className="w-[85%] lg:w-[90%] mx-auto">
          <div className="flex w-full justify-between items-center h-[50px] text-slate-500">
            <ul className="flex justify-start items-center gap-8">
              ...
              <span>KeHager Bet Multivendor</span>
            </ul>
            <div>
                ...
                <ul className="flex justify-start items-start gap-8 text-sm font-bold uppercase md-lg:hidden">
                  <li>
                    <Link
                      to="/"
                      className={`p-2 block ${
                        pathname === "/" ? "text-[#EA4D1B]" : "text-slate-600"
                      }`}
                    >
                      Home
                    </Link>
            ...
            <ul className="flex flex-col justify-start items-start  text-md font-semibold uppercase">
              ...
              <li>
                <Link
                  to={"/shops"}
                  className={`py-2 block ${
                    pathname === "/shops" ? "text-[#EA4D1B]" : "text-slate-600"
                  }`}
                >
                  Shop
                </Link>
              ...
              <li>
                <Link
                  to="/blog"
                  className={`py-2 block ${
                    pathname === "/blog" ? "text-[#EA4D1B]" : "text-slate-600"
                  }`}
                >
                  Blog
                </Link>
              ...
              <li>
                <Link
                  to="/about"
                  className={`py-2 block ${
                    pathname === "/about" ? "text-[#EA4D1B]" : "text-slate-600"
                  }`}
                >
                  About
                </Link>
          ...
          <div className="w-3/12 md-lg:w-full">
            <div className="bg-white relative">
              <div
                ...
                className="h-[50px] bg-[#EA4D1B] text-white flex justify-center md-lg:justify-between md-lg:px-6 items-center gap-3 font-bold text-md cursor-pointer"
              >
            ...
            <div className="flex flex-wrap w-full justify-between items-center md-lg:gap-6">
              <div className="w-8/12 md-lg:w-full">
                <div className="flex border h-[50px] items-center relative gap-5">
                  ...
                  <button
                    onClick={search}
                    className="bg-[#EA4D1B] right-0 absolute px-8 h-full font-semibold uppercase text-white"
                  >
                    Search
                  </button>
                </div>
