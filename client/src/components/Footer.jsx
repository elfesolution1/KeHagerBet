    ...
    <footer className="bg-[#F3F6Fa]">
          ...
          <div className="w-full flex flex-col justify-start gap-5">
            ...
            <div className="h-[50px] w-full bg-white border relative">
              <input
                ...
                type="text"
              />
              <button className="h-full absolute right-0 bg-[#EA4D1B] text-white uppercase px-4 font-bold text-sm">
                Subscribe
              </button>
            </div>
      ...
      <div className="w-[85%] flex flex-wrap justify-center items-center text-slate-600 mx-auto py-5 text-center">
        <span>
          ...
          <a className="text-[#EA4D1B] underline" href="">
            Elfe Digital
          </a>
        </span>
      </div>
